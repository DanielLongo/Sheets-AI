...
function Progress({stepIndex}) {
    const steps = [
        { id: '01', name: 'Data Upload', href: '#', status: stepIndex === 0 ? 'current' : 'complte'},
        { id: '02', name: 'Variable Selection', href: '#', status: stepIndex === 1 ? 'current' : stepIndex === 0 ? 'upcoming' : 'complete' },
        { id: '03', name: 'Deploy', href: '#', status: stepIndex === 2 ? 'current' : 'upcoming' },
      ]
